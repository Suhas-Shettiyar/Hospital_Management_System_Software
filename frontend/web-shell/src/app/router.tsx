...
export function createAppRouter(): AppRouter {
  return createBrowserRouter([
    ...
    // /dashboard for authenticated ones (patients included - see RootGate's
    // own comment for why there's no more role branch here). Login is
    // modal-only now — there is no standalone /login route.
